...
_lr_productions = [
  ...
  ('assign -> IDENTIFIER ASSIGNMENT NUMBA','assign',3,'p_assign','jolt_yacc.py',189),
  ('assign -> IDENTIFIER ASSIGNMENT DECI','assign',3,'p_assign','jolt_yacc.py',190),
  ('assign -> IDENTIFIER ASSIGNMENT WUD','assign',3,'p_assign','jolt_yacc.py',191),
  ('assign -> IDENTIFIER ASSIGNMENT LETTA','assign',3,'p_assign','jolt_yacc.py',192),
  ('assign -> IDENTIFIER ASSIGNMENT WHICHEVA','assign',3,'p_assign','jolt_yacc.py',193),
  ('assign -> IDENTIFIER ASSIGNMENT expression','assign',3,'p_assign','jolt_yacc.py',194),
  ('print -> SHOW OPENBRACE WUD CLOSEBRACE','print',4,'p_print_show','jolt_yacc.py',204),
  ('print -> SHOW OPENBRACE LETTA CLOSEBRACE','print',4,'p_print_show','jolt_yacc.py',205),
  ('print -> SHOW OPENBRACE IDENTIFIER CLOSEBRACE','print',4,'p_print_show','jolt_yacc.py',206),
  ('print -> SHOW OPENBRACE factor CLOSEBRACE','print',4,'p_print_show2','jolt_yacc.py',215),
]
